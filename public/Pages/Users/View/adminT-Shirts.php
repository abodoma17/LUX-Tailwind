    ...
    <div class="flex w-screen justify-center mt-4">
            ...
            <table class="border-separate border border-gray-500 table-auto">
                <thead>
                    <tr class="uppercase text-xl bg-gray-800">
                        <th class="border border-gray-600 p-4">tID</th>
        ...
        <div class="md:grid md:grid-cols-2 mt-10">
            ...
            <div>
                ...
                <form method="POST" action="../Controller/addT-ShirtsHandler.php" class="text-center bg-white text-black rounded-lg max-w-md"> 
                    <div class="mx-10">
            ...
            <div class="md:border-l-2 md:border-white flex-col justify-center align-center text-center">
                ...
                <div class="flex w-full justify-center align-center">
                    <form method ="POST"
                    action="../Controller/deleteT-ShirtsHandler.php" class="block mt-5">
                        <div>
