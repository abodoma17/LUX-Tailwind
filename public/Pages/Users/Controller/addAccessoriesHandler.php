<?php
    ...
    $query = "INSERT INTO accessories(name,description,price,bg,weight,width,height,image1,image2) value ('$nameInput','$descriptionInput','$priceInput','$bgInput','$weightInput','$widthInput','$heightInput','$image1input','$image2')";
