<?php
    ...
    $query = "INSERT INTO products(name,description,price,bg,weight,width,height,image1,image2,cID) value ('$nameInput','$descriptionInput','$priceInput','$bgInput','$weightInput','$widthInput','$heightInput','$image1input','$image2',1)";
