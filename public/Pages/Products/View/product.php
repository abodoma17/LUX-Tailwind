...
<body class="text-white bg-primary">
        ...
        <div class="md:grid md:grid-cols-3">
            ...
            <div class="w-11/12 mx-auto my-10">
                <img id="productImg" src="../../../Shared/Images/accessories.jpg" onmouseover="changePic();" onmouseout="restorePic();">
            </div>

            <div class="md:col-span-2 my-12 ml-5">

                <h1 class="text-5xl mb-1 font-serif">Sphinx Necklace Pendant</h1>
                <h2 class="text-2xl font-mono" id="">Unisex necklace pendant made of stainless steel. </h2>
                <div class="flex">
                    <p class="text-xl text-yellow-100 font-nunito mr-2" id="price">50.00</p>
                ...
                <h5 class="text-l font-semibold mb-3 font-nunito">The original sphinx had a long braided beard and a nose, and it was painted in bright colours. </h5>

                <h3 class="text-2xl border-b-2 inline font-serif" id="">Dimensions:</h3>
                    
                <h4 class="text-l mt-5 font-bold">Weight: 350gm</h4>
                <h4 class="text-l font-bold">Height: 5cm</h4>
                <h4 class="text-l font-bold">Width: 2cm</h4>
            </div>
        </div>
