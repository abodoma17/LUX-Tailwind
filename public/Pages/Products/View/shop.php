...
<body class="bg-primary text-white">
  <div class="">
    ...
    <main>
        <div class="md:flex">
            <div class="md:flex-none lg:w-3/12">
            </div>
            <!--CARDS GO HERE-->
            <div class=" text-center md:flex-grow md:w-3/4">
                <h1 class="text-center lg:text-6xl border-b-2 py-4 inline-block font-serif my-4 text-4xl">Categories</h1>
                <div class="md:grid md:grid-cols-3 md:gap-10 grid grid-cols-2 gap-6 text-center md:mx-16 mx-5 ">
                    <a href="./viewAll.php">
                        <div class="cursor-pointer bg-primary rounded-lg p-2 transform transition duration-300 ease-in-out hover:scale-110 hover:drop-shadow-cardhover" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.75);">
                            <img src="../../../Shared/Images/viewAll.jpg" alt="" class="md:bg-cover pb-3">
                            <span class="font-serif text-2xl">View All</span>
                        </div>
                    </a>

                    <a href="./accessoriesCategory.php">
                        <div class="cursor-pointer bg-primary rounded-lg p-2 transform transition duration-300 ease-in-out hover:scale-110 hover:drop-shadow-cardhover" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.75);">
                            <img src="../../../Shared/Images/accessories.jpg" alt="" class="md:bg-cover pb-3">
                    ...
                    <a href="./papyrusCategory.php">
                        <div class="cursor-pointer bg-primary rounded-lg p-2 transform transition duration-300 ease-in-out hover:scale-110 hover:drop-shadow-cardhover" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.75);">
                            <img src="../../../Shared/Images/papyrus2.jpg" alt="" class="md:bg-cover pb-3">
                            <span class="font-serif text-2xl">Papyrus</span>
                        </div>
                    </a>
                    ...
                    <a href="./tshirtCategory.php">
                        <div class="cursor-pointer bg-primary rounded-lg p-2 transform transition duration-300 ease-in-out hover:scale-110 hover:drop-shadow-cardhover" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.75);">
                            <img src="../../../Shared/Images/tshirt1.jpg" alt="" class="md:bg-cover pb-3">
                            <span class="font-serif text-2xl">T-Shirts</span>
                        </div>
                    </a>
